...
;   capstone2_staffapp\installer\Syswatch_Admin_Installer_v2.8.1.iss
...
#define VCRedistPath AddBackslash(SourcePath) + VCRedistFile
  ...
  #error "The Syswatch Admin login screen was not found. Check that this is the Admin project."
#endif
...
[UninstallDelete]
; Configuration and session data stored under the Windows user profile are
; deliberately preserved when the application is uninstalled.
