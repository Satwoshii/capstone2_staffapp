...
import '../services/pc_health_prediction_service.dart';
...
class _RoomPcStatusScreenState extends State<RoomPcStatusScreen> {
                ...
                return SingleChildScrollView(
                  ...
                  child: Wrap(
                    ...
                    children: filteredRecords.map((record) {
                      return SizedBox(
                        width: itemWidth,
                        height: 350, // Extra room for predictive-health status
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildPredictionBadge(prediction),
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Divider(height: 1, color: _borderColor),
                          const SizedBox(height: 16),
                          _buildPredictionDetails(prediction),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget _buildPredictionBadge(PcHealthPrediction prediction) {
    if (!prediction.ready) {
      return Container(
        ...
        child: Text(
          'PREDICTION ${prediction.historyCount}/3',
          style: TextStyle(
            color: _subTextColor,
            fontSize: 9.5,
            fontWeight: FontWeight.w800,
    ...
    final color = _predictionColor(prediction.riskLevel);
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 5),
      decoration: BoxDecoration(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.timeline_rounded, size: 12, color: color),
          const SizedBox(width: 6),
          Text(
            'FUTURE RISK ${prediction.riskLevel.toUpperCase()} • ${prediction.riskScore}/100',
            style: TextStyle(
              color: color,
              fontSize: 9.5,
              fontWeight: FontWeight.w900,
  ...
  Widget _buildPredictionDetails(PcHealthPrediction prediction) {
    if (!prediction.ready) {
      return Container(
        width: double.infinity,
        padding: const EdgeInsets.all(14),
        decoration: BoxDecoration(
          color: _fieldColor.withValues(alpha: 0.55),
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: _borderColor),
        ),
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.timeline_rounded, size: 18, color: _accentAForeground),
                const SizedBox(width: 8),
                Text(
            ...
            Text(
              prediction.summary,
              style: TextStyle(color: _subTextColor, fontSize: 12.5, height: 1.45),
            ),
          ],
        ),
      );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${prediction.riskLevel.toUpperCase()} ${prediction.riskScore}/100',
          ...
          Text(
            prediction.summary,
            style: TextStyle(color: _textColor.withValues(alpha: 0.86), fontSize: 12.5, height: 1.45),
          ),
          if (prediction.reasons.isNotEmpty) ...[
            const SizedBox(height: 12),
            Text(
              'Main warning factors',
              style: TextStyle(color: _textColor, fontSize: 12, fontWeight: FontWeight.w800),
            ),
          ...
          ExpansionTile(
            ...
            children: prediction.components.map((component) {
              final componentColor = _predictionColor(component.riskLevel);
              return Padding(
                padding: const EdgeInsets.only(bottom: 8),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SizedBox(
                      ...
                      child: Text(
                        component.component,
                        style: TextStyle(color: componentColor, fontSize: 11.5, fontWeight: FontWeight.w700),
                      ),
                    ),
                    Expanded(
                      child: Text(
                        '${component.riskLevel.toUpperCase()} (${component.riskScore}/100) — ${component.message}',
                        style: TextStyle(color: _subTextColor, fontSize: 11.5, height: 1.35),
                      ),
                    ),
                  ],
                ),
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            ...
            child: Text(
              label,
              style: TextStyle(color: _subTextColor, fontSize: 11.5, fontWeight: FontWeight.w600),
            ),
          ),
          Expanded(
            child: Text(
              value,
              style: TextStyle(color: _textColor, fontSize: 11.5, fontWeight: FontWeight.w700),
            ),
          ),
        ],
      ),
  ...
  Color _predictionColor(String level) {
