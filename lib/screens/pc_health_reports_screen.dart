...
class _PcHealthReportsScreenState extends State<PcHealthReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PcHealthRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final totalIssues = allRecords.where(_recordNeedsAttention).length;
              ...
              child: Builder(
                builder: (context) {
                  ...
                  final filteredRecords = allRecords.where((record) {
                    ...
                    if (_issuesOnly && !_recordNeedsAttention(record)) return false;
  ...
  Widget _buildRoomCard(String roomName, List<PcHealthRecord> records) {
    final issueCount = records.where(_recordNeedsAttention).length;
